...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _services_spinner_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    ...
    var AppComponent = /*#__PURE__*/function () {
      function AppComponent(router, route, authService, eventService, shareEvent, shareUser, spinner) {
        var _this = this;
        ...
        this.spinner.get().subscribe(function (resp) {
          return _this.spinner_status = resp;
        });
      }
      ...
      _createClass(AppComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.authService.getLoggedInUser().subscribe(function (resp) {
            _this2.logged_in_user = resp;
          });
          this.shareUser.getUser().subscribe(function (resp) {
            return _this2.user = resp;
          });
        }
      }, {
        key: "goToProfile",
        ...
        value: function getAllEvents() {
          ...
          this.eventService.getEventList().subscribe(function (resp) {
            _this3.spinner.remove();

            console.log(typeof resp.body.results);
            console.log("received events from http");
            _this3.event_list = resp.body.results;

            _this3.shareEvent.setShareEvents(_this3.event_list);
          }, function (error) {
            alert(error);
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function AppComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](31, "Album example is \xA9 Bootstrap, but please download and customize it for yourself!");
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _services_spinner_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ./services/spinner.service */
    "./src/app/services/spinner.service.ts");
    /* harmony import */


    var _app_authentication_register_register_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! @app/authentication/register/register.component */
    "./src/app/authentication/register/register.component.ts");
    /* harmony import */


    var _app_authentication_login_login_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! @app/authentication/login/login.component */
    "./src/app/authentication/login/login.component.ts");
    /* harmony import */


    var _app_dashboard_events_event_list_event_list_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    /*! @app/dashboard/events/event-list/event-list.component */
    "./src/app/dashboard/events/event-list/event-list.component.ts");
    /* harmony import */


    var _app_dashboard_events_event_detail_event_detail_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    /*! @app/dashboard/events/event-detail/event-detail.component */
    "./src/app/dashboard/events/event-detail/event-detail.component.ts");
    /* harmony import */


    var _app_dashboard_profile_profile_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
    /*! @app/dashboard/profile/profile.component */
    "./src/app/dashboard/profile/profile.component.ts");
    /* harmony import */


    var _app_dashboard_page_not_found_page_not_found_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
    /*! @app/dashboard/page-not-found/page-not-found.component */
    "./src/app/dashboard/page-not-found/page-not-found.component.ts");
    /* harmony import */


    var _app_dashboard_admin_admin_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
    /*! @app/dashboard/admin/admin.component */
    "./src/app/dashboard/admin/admin.component.ts");
    /* harmony import */


    var _app_dashboard_admin_user_update_by_admin_user_update_by_admin_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
    /*! @app/dashboard/admin/user-update-by-admin/user-update-by-admin.component */
    "./src/app/dashboard/admin/user-update-by-admin/user-update-by-admin.component.ts");
    /* harmony import */


    var _app_dashboard_events_event_create_event_create_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
    /*! @app/dashboard/events/event-create/event-create.component */
    "./src/app/dashboard/events/event-create/event-create.component.ts");
    /* harmony import */


    var _app_dashboard_profile_profile_update_profile_update_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(
    /*! @app/dashboard/profile/profile-update/profile-update.component */
    "./src/app/dashboard/profile/profile-update/profile-update.component.ts");
    /* harmony import */


    var _app_dashboard_profile_profile_image_profile_image_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(
    /*! @app/dashboard/profile/profile-image/profile-image.component */
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      ...
      providers: [_app_services_rest_api_server_service__WEBPACK_IMPORTED_MODULE_7__["RestApiServerService"], _services_spinner_service__WEBPACK_IMPORTED_MODULE_9__["SpinnerService"], {
  ...
  function srcAppAuthenticationLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _app_services_spinner_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! @app/services/spinner.service */
    "./src/app/services/spinner.service.ts");
    /* harmony import */
    ...
    var LoginComponent = /*#__PURE__*/function () {
      function LoginComponent(authService, router, route, shareUser, userService, spinner) {
        ...
        this.spinner = spinner; //represents if anyone is logged in?
      ...
      _createClass(LoginComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.authService.getLoggedInUser().subscribe(function (resp) {
            _this4.loginStatus = resp["loginStatus"];
          });
          ...
          this.shareUser.getUser().subscribe(function (resp) {
            return _this4.username = resp["username"];
          });
        ...
        value: function login() {
          ...
          function (resp) {
            ...
            _this5.authService.updateData(); //getting user profile after login---


            _this5.getUserFromHttp(); //getting user profile image from amazon aws


            _this5.getProfileImage();
          }, function (error) {
            _this5.spinner.remove();
        ...
        value: function getUserFromHttp() {
          ...
          this.authService.getUser().subscribe(function (resp) {
            ...
            _this6.shareUser.setUser(user);

            _this6.spinner.remove();
          }, function (error) {
            _this6.spinner.remove();
        ...
        value: function getProfileImage() {
          ...
          this.userService.getProfileImage().subscribe(function (resp) {
            _this7.spinner.remove();

            _this7.shareUser.setProfileImage(resp.body);
          }, function (error) {
            _this7.spinner.remove();
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](LoginComponent, [{
        ...
        return [{
          ...
          type: _app_services_spinner_service__WEBPACK_IMPORTED_MODULE_7__["SpinnerService"]
        }];
      }, null);
    })();
    /***/
  ...
  function srcAppAuthenticationRegisterRegisterComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _app_services_spinner_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! @app/services/spinner.service */
    "./src/app/services/spinner.service.ts");
    /* harmony import */
    ...
    var RegisterComponent = /*#__PURE__*/function () {
      function RegisterComponent(authService, registerService, router, route, spinner) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](RegisterComponent, [{
        ...
        return [{
          ...
          type: _app_services_spinner_service__WEBPACK_IMPORTED_MODULE_6__["SpinnerService"]
        }];
      }, null);
    })();
    /***/
  ...
  function srcAppDashboardAdminAdminComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _app_services_spinner_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! @app/services/spinner.service */
    "./src/app/services/spinner.service.ts");
    /* harmony import */
    ...
    var _app_dashboard_admin_user_update_by_admin_user_update_by_admin_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! @app/dashboard/admin/user-update-by-admin/user-update-by-admin.component */
    "./src/app/dashboard/admin/user-update-by-admin/user-update-by-admin.component.ts");
    ...
    var AdminComponent = /*#__PURE__*/function () {
      function AdminComponent(userService, shareUser, spinner) {
        _classCallCheck(this, AdminComponent);

        this.userService = userService;
        this.shareUser = shareUser;
        this.spinner = spinner; //show user details table?
      ...
      _createClass(AdminComponent, [{
        ...
        value: function onSearch() {
          ...
          this.userService.getUserByUsername(this.username).subscribe(function (resp) {
            _this9.spinner.remove();

            _this9.user = resp.body;
            _this9.showTable = true; //table is displayed on successfully receiving user
          }, function (error) {
            _this9.spinner.remove();
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AdminComponent, [{
        ...
        return [{
          ...
          type: _app_services_spinner_service__WEBPACK_IMPORTED_MODULE_5__["SpinnerService"]
        }];
      }, null);
    })();
    /***/
  ...
  function srcAppDashboardAdminUserUpdateByAdminUserUpdateByAdminComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _app_services_spinner_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! @app/services/spinner.service */
    "./src/app/services/spinner.service.ts");
    /* harmony import */
    ...
    var UserUpdateByAdminComponent = /*#__PURE__*/function () {
      function UserUpdateByAdminComponent(userService, spinner) {
    ...
    UserUpdateByAdminComponent.ɵfac = function UserUpdateByAdminComponent_Factory(t) {
      return new (t || UserUpdateByAdminComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_app_services_user_service__WEBPACK_IMPORTED_MODULE_1__["UserService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_app_services_spinner_service__WEBPACK_IMPORTED_MODULE_2__["SpinnerService"]));
    };
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](UserUpdateByAdminComponent, [{
        ...
        return [{
          ...
          type: _app_services_spinner_service__WEBPACK_IMPORTED_MODULE_2__["SpinnerService"]
        }];
      }, {
        updated_user: [{
  ...
  function srcAppDashboardEventsEventCreateEventCreateComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var EventCreateComponent = /*#__PURE__*/function () {
      function EventCreateComponent(eventService, spinner) {
        _classCallCheck(this, EventCreateComponent);

        this.eventService = eventService;
        this.spinner = spinner; //initially true so that errors are not shown
    ...
    EventCreateComponent.ɵfac = function EventCreateComponent_Factory(t) {
      return new (t || EventCreateComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_app_services_event_service__WEBPACK_IMPORTED_MODULE_4__["EventService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_app_services_spinner_service__WEBPACK_IMPORTED_MODULE_5__["SpinnerService"]));
    };
  ...
  function srcAppDashboardEventsEventDetailEventDetailComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _app_services_spinner_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    /*! @app/services/spinner.service */
    "./src/app/services/spinner.service.ts");
    /* harmony import */
    ...
    var EventDetailComponent = /*#__PURE__*/function () {
      function EventDetailComponent(router, route, shareEvent, authService, shareUser, bidService, eventService, spinner) {
        ...
        this.eventService = eventService;
        this.spinner = spinner; //to obtain event id for which details need to be shown
      ...
      _createClass(EventDetailComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.shareEvent.getShareEvents().subscribe(function (val) {
            if (val.length != 0) {
              _this13.event = val.filter(function (x) {
                return x.id == _this13.event_id;
              })[0];

              if (_this13.event != null) {
                //callback that is executed only after receiving event details
                _this13.authService.getLoggedInUser().subscribe(function (resp) {
                  return _this13.is_staff = resp["is_staff"];
                });

                var current_datetime = Date.now();

                var parsed_start_date = _this13.parse_date(_this13.event.start_date); //converts in milliseconds since epoch


                var parsed_deadline = _this13.parse_date(_this13.event.deadline);

                if (current_datetime >= parsed_start_date && current_datetime < parsed_deadline) {
                  _this13.can_bid = true; //getting 'is_bidder' property of currently logged in user

                  _this13.shareUser.getUser().subscribe(function (val) {
                    return _this13.is_bidder = val.profile["is_bidder"];
                  }); //will tell if user is admin


                  console.log(_this13.is_bidder + " " + _this13.can_bid);
                }
              }
            }
          });
        ...
        value: function getHighestBid() {
          ...
          this.bidService.retrieveHighestBid(this.event_id).subscribe(function (resp) {
            _this16.spinner.remove();

            _this16.highest_bid = resp.body["highest_bid"];
            _this16.highest_bid_user = resp.body["user"];
          }, function (error) {
            _this16.spinner.remove();
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](EventDetailComponent, [{
        ...
        return [{
          ...
          type: _app_services_spinner_service__WEBPACK_IMPORTED_MODULE_13__["SpinnerService"]
        }];
      }, null);
    })();
    /***/
      ...
      _createClass(EventListComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.shareEvent.getShareEvents().subscribe(function (value) {
            _this17.eventList = value;
            _this17.filtered_set = _this17.eventList;
          });
  ...
  function srcAppDashboardProfileProfileImageProfileImageComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _app_services_spinner_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! @app/services/spinner.service */
    "./src/app/services/spinner.service.ts");
    /* harmony import */
    ...
    var ProfileImageComponent = /*#__PURE__*/function () {
      function ProfileImageComponent(shareUser, userService, spinner) {
      ...
      _createClass(ProfileImageComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.shareUser.getProfileImage().subscribe(function (resp) {
            return _this18.image_object = resp;
          });
        }
      }, {
        key: "onFileSelect",
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ProfileImageComponent, [{
        ...
        return [{
          ...
          type: _app_services_spinner_service__WEBPACK_IMPORTED_MODULE_3__["SpinnerService"]
        }];
      }, null);
    })();
    /***/
  ...
  function srcAppDashboardProfileProfileUpdateProfileUpdateComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ProfileUpdateComponent = /*#__PURE__*/function () {
      function ProfileUpdateComponent(userService, spinner) {
    ...
    ProfileUpdateComponent.ɵfac = function ProfileUpdateComponent_Factory(t) {
      return new (t || ProfileUpdateComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_app_services_user_service__WEBPACK_IMPORTED_MODULE_1__["UserService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_app_services_spinner_service__WEBPACK_IMPORTED_MODULE_2__["SpinnerService"]));
    };
  ...
  function srcAppDashboardProfileProfileComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _app_dashboard_profile_profile_update_profile_update_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! @app/dashboard/profile/profile-update/profile-update.component */
    "./src/app/dashboard/profile/profile-update/profile-update.component.ts");
    ...
    var ProfileComponent = /*#__PURE__*/function () {
      function ProfileComponent(authService, router, route, shareUser, userService, spinner) {
      ...
      _createClass(ProfileComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.shareUser.getProfileImage().subscribe(function (resp) {
            _this21.image_object = resp;
            console.log(JSON.stringify(_this21.image_object));
          });
        }
      }, {
        key: "updateProfile",
        ...
        value: function refreshProfile() {
          ...
          this.authService.getUser().subscribe(function (resp) {
            _this22.spinner.remove();

            alert("refreshed");

            _this22.shareUser.setUser(resp.body);
          }, function (error) {
            _this22.spinner.remove();
          ...
          this.userService.getProfileImage().subscribe(function (resp) {
            ...
            _this22.shareUser.setProfileImage(resp.body);
          });
        }
      }]);
    ...
    ProfileComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      directives: [_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterLinkWithHref"], _angular_common__WEBPACK_IMPORTED_MODULE_6__["NgIf"], _app_dashboard_profile_profile_update_profile_update_component__WEBPACK_IMPORTED_MODULE_7__["ProfileUpdateComponent"]],
      ...
      _createClass(AdminGuardService, [{
        ...
        value: function canActivate() {
          ...
          this.authService.getLoggedInUser().subscribe(function (value) {
            _this23.loginStatus = value["loginStatus"];
            _this23.is_staff = value["is_staff"];
          });
      ...
      _createClass(AuthGuardService, [{
        ...
        value: function canActivate() {
          ...
          this.auth.getLoggedInUser().subscribe(function (resp) {
            _this24.loginStatus = resp["loginStatus"];
          });
  ...
  function srcAppServicesAuthInterceptorTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*! ./spinner.service */
    "./src/app/services/spinner.service.ts"); //to send Json web token with each request in headers...if present.
    //Note:null value is not send


    var AuthTokenInterceptor = /*#__PURE__*/function () {
      function AuthTokenInterceptor(spinnerService) {
    ...
    AuthTokenInterceptor.ɵfac = function AuthTokenInterceptor_Factory(t) {
      return new (t || AuthTokenInterceptor)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_spinner_service__WEBPACK_IMPORTED_MODULE_1__["SpinnerService"]));
    };
  ...
  function srcAppServicesAuthServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _spinner_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./spinner.service */
    "./src/app/services/spinner.service.ts"); //to read jwt-token payload


    var AuthService = /*#__PURE__*/function () {
      function AuthService(http, jwtHelper, restapi, spinner) {
        _classCallCheck(this, AuthService);

        this.http = http;
        this.jwtHelper = jwtHelper;
        this.restapi = restapi;
        this.spinner = spinner; //behavior subject containing loginStatus, (expiration,is_staff and user_id)-->from token
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AuthService, [{
        ...
        return [{
          ...
          type: _spinner_service__WEBPACK_IMPORTED_MODULE_8__["SpinnerService"]
        }];
      }, null);
    })();
    /***/
  ...
  function srcAppServicesBidServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _spinner_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./spinner.service */
    "./src/app/services/spinner.service.ts");

    var BidService = /*#__PURE__*/function () {
      function BidService(http, restapi, spinner) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](BidService, [{
        ...
        return [{
          ...
          type: _spinner_service__WEBPACK_IMPORTED_MODULE_5__["SpinnerService"]
        }];
      }, null);
    })();
    /***/
    ...
    var CanAuctionGuardService = /*#__PURE__*/function () {
      ...
      _createClass(CanAuctionGuardService, [{
        ...
        value: function canActivate() {
          ...
          this.authService.getLoggedInUser().subscribe(function (resp) {
            return _this25.loginStatus = resp["loginStatus"];
          });
          this.shareUser.getUser().subscribe(function (resp) {
            return _this25.can_auction = resp.profile["is_auctioneer"];
          });
  ...
  function srcAppServicesEventServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var EventService = /*#__PURE__*/function () {
      function EventService(http, restapi, spinner) {
  ...
  function srcAppServicesRegisterServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var RegisterService = /*#__PURE__*/function () {
      function RegisterService(http, restapi, spinner) {
  ...
  function srcAppServicesUserServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var UserService = /*#__PURE__*/function () {
      function UserService(http, restapi, spinner) {
